...
function solution_func() {
	...
	$labels = array(
		'name'                  => _x( 'Giải Pháp', 'Post Type General Name', 'sontq' ),
		'singular_name'         => _x( 'Giải Pháp', 'Post Type Singular Name', 'sontq' ),
		'menu_name'             => __( 'Giải Pháp', 'sontq' ),
		'name_admin_bar'        => __( 'Giải Pháp', 'sontq' ),
	...
	$args = array(
		'label'                 => __( 'Giải Pháp', 'sontq' ),
		'description'           => __( 'Post Type Solution', 'sontq' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'comments', 'trackbacks', 'revisions', 'custom-fields', 'page-attributes', 'post-formats' ),
		'taxonomies'            => array( 'solution_group' ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
...
add_action( 'init', 'solution_func', 0 );


// Register Sector Taxonomy
// function solution_group_func() {

//     $labels = array(
//         'name'                       => _x( 'Group Solution', 'Taxonomy General Name', 'sontq' ),
//         'singular_name'              => _x( 'Group Solution', 'Taxonomy Singular Name', 'sontq' ),
//         'menu_name'                  => __( 'Group Solution', 'sontq' ),
//         'all_items'                  => __( 'All Items', 'sontq' ),
...
//         'show_tagcloud'              => true,
//     );
//     register_taxonomy( 'solution_group', array( 'solution' ), $args );

// }
// add_action( 'init', 'solution_group_func', 0 );
